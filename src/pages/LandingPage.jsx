    ...
    return (
        <>
            <header className='headerLanding '>
                <h1 className=" m-0 ">BULL BAR APP SERVICE</h1>
            ...
            <nav className="navBarLanding">
                <ul>
                    ...
                    <li><button>Recomendaciones</button></li>
                    <li><button>Prueba de 7 dias</button></li>
                </ul>
            </nav>
            <main className="mainLanding" >
                <section>
                    ...
                    <section className='navBarLanding'>INFORMACION</section>
                    <section className='contendoresIntroduccionServicio fondoOscuro'>
                        <article>
                            <h3>¿QUE ES BULL BAR APP?</h3>
                    ...
                    <section className='navBarLanding'>PRECIOS</section>
                    ...
                    <section className='navBarLanding'>Recomendaciones</section>
                    ...
                    <section className='navBarLanding'>Prueba de 7 días</section>
                    ...
                    <section className='navBarLanding'></section>

                </section>
            </main>
            <footer className="footerLanding">
                <h2>SOY EL FOOTER</h2>
                <p>Copyright ©, Bull Bar App Service</p>
            </footer>
        </>
    )
};
